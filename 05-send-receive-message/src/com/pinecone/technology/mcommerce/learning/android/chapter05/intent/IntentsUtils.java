...
public class IntentsUtils 
{
    ...
    public static void parseResult(IntentFilterActivity activity
    		, int requestCode
    		, int resultCode
    		, Intent outputIntent)
    	{
    ...
    public static void parseResultForPick(IntentFilterActivity activity
    		, int requestCode
    		, int resultCode
    		, Intent outputIntent)
    	{
        ...
        public static void parseResultForContent(IntentFilterActivity activity
    		, int requestCode
    		, int resultCode
    		, Intent outputIntent)
    	{
