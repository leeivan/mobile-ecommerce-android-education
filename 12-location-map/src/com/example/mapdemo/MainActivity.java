...
import com.pinecone.technology.mcommerce.learning.android.chapter12.ShowLocationActivity;
...
public final class MainActivity extends ListActivity {
	...
	/**
	 * A simple POJO that holds the details about the demo that are used by the
	 * List Adapter.
	 */
	...
	private static class CustomArrayAdapter extends ArrayAdapter<DemoDetails> {
		...
		/**
		 * @param demos
		 *            An array containing the details of the demos to be
		 *            displayed.
		 */
	...
	private static final DemoDetails[] demos = {
			new DemoDetails(R.string.map01, R.string.map01_description,
			...
			new DemoDetails(R.string.my_location_demo,
			...
			new DemoDetails(R.string.tile_overlay_demo,
					R.string.tile_overlay_description,
					TileOverlayDemoActivity.class),
			new DemoDetails(R.string.options_demo,
					R.string.options_description, OptionsDemoActivity.class),
			new DemoDetails(R.string.multi_map_demo,
					R.string.multi_map_description, MultiMapDemoActivity.class),
			new DemoDetails(R.string.retain_map,
					R.string.retain_map_description, RetainMapActivity.class),
			new DemoDetails(R.string.raw_mapview_demo,
					R.string.raw_mapview_description,
			...
			new DemoDetails(R.string.save_state_demo,
					R.string.save_state_description,
					SaveStateDemoActivity.class),
			new DemoDetails(R.string.snapshot_demo,
					R.string.snapshot_description, SnapshotDemoActivity.class) };
