...
/**
 * 测试OAuth Version 2.a的API封装接口，本类中只演示三个代表性接口调用（分别采用Get方法发送消息，post方法发送消息和post方法发送文件）
 */
            ...
            public void onClick(View view) {
                switch(view.getId()){
                    ...
                    case R.id.btnSendMsg:
                        ...
                        try {
                            response=tAPI.add(oAuthV2, "json", "Android客户端文字微博2", "127.0.0.1");
                            textResponse.append(response+"\n");
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    ...
                    case R.id.btnSendMsgWithPic:
                        ...
                        try {
                            ...
                            response=tAPI.addPic(oAuthV2,  "json",  "Android客户端带图的文字微博", "127.0.0.1", picPath);
                            textResponse.append(response+"\n");
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
