...
public class ActionBarDisplayOptions extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.c04_action_bar_display_options);
        ...
        mCustomView = getLayoutInflater().inflate(R.layout.c04_action_bar_display_options_custom, null);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.c04_display_options_actions, menu);
        return true;
    }
