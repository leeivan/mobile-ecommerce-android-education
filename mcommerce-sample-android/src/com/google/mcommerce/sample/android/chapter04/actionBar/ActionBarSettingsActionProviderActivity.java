...
public class ActionBarSettingsActionProviderActivity extends Activity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.c04_action_bar_settings_action_provider, menu);
        return true;
    }
    ...
    public static class SettingsActionProvider extends ActionProvider {
        ...
        public View onCreateActionView() {
            ...
            View view = layoutInflater.inflate(R.layout.c04_action_bar_settings_action_provider, null);
