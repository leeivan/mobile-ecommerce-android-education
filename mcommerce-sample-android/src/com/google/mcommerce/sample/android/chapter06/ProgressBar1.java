...
/**
 * Demonstrates how to use progress bars as widgets and in the title bar. The
 * progress bar in the title will be shown until the progress is complete, at
 * which point it fades away.
 */
public class ProgressBar1 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.c06_progressbar_1);
