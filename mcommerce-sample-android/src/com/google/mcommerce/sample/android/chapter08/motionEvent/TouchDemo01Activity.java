...
public class TouchDemo01Activity extends Activity implements OnTouchListener {
	/** Called when the activity is first created. */
	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.c08_touch_demo01_layout);
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		if ("true".equals(myTag.substring(0, 4))) {
			 ...
			 * v.onTouchEvent(event); Log.v(myTag,
			 * "*** back from onTouchEvent() method ***");
			 */
