...
public class AccelerometerRecordToFileActivity extends Activity implements SensorEventListener {
    ...
    public BroadcastReceiver mReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            if (Intent.ACTION_SCREEN_OFF.equals(intent.getAction())) {
                ...
                mMgr.registerListener(AccelerometerRecordToFileActivity.this, mAccel,
